...
const ORDER = ["vor", "survive", "range", "score", "dropoff",
               ...
               "pos_rank", "grade", "off_board", "projected", "season_total", "curve_now",
...
const LABEL: Record<string, string> = {
  ...
  off_board: "Off the board", projected: "Projected points", season_total: "Season points", curve_now: "Grey curve",
